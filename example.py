...
if __name__ == "__main__":
    ...
    parser.add_argument("--population_size", default=None, type=None, help="population size used for genetic algorithm (default: None)")
    parser.add_argument("--max_iter", default=100, type=int, help="genetic algorithm iteration steps (default: 100)")
    parser.add_argument("--mutate_prob", default=0.01, type=float, help="genetic algorithm mutation probability (default: 0.1)")
